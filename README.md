...
// instantFormat: PBFormat[Instant] = pbdirect.PBFormat$$anon$1@5eb54c78
```
...
// instantReader: PBScalarValueReader[Instant] = pbdirect.PBScalarValueReaderImplicits$FunctorReader$$anon$2@7a947394
```
...
// instantWriter: PBScalarValueWriter[Instant] = pbdirect.PBScalarValueWriterImplicits$ContravariantWriter$$anon$2@4239c75b
```

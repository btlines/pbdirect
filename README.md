...
// instantFormat: PBFormat[Instant] = pbdirect.PBFormat$$anon$1@39639875
```
...
// instantReader: PBScalarValueReader[Instant] = pbdirect.PBScalarValueReaderImplicits$FunctorReader$$anon$2@4e29fdeb
```
...
// instantWriter: PBScalarValueWriter[Instant] = pbdirect.PBScalarValueWriterImplicits$ContravariantWriter$$anon$2@70e50492
```

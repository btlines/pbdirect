...
// instantFormat: PBFormat[Instant] = pbdirect.PBFormat$$anon$1@5ce3fd19
```
...
// instantReader: PBScalarValueReader[Instant] = pbdirect.PBScalarValueReaderImplicits$FunctorReader$$anon$2@24b2e5
```
...
// instantWriter: PBScalarValueWriter[Instant] = pbdirect.PBScalarValueWriterImplicits$ContravariantWriter$$anon$2@402f90df
```

...
// instantFormat: PBFormat[Instant] = pbdirect.PBFormat$$anon$1@1c1d832d
```
...
// instantReader: PBScalarValueReader[Instant] = pbdirect.PBScalarValueReaderImplicits$FunctorReader$$anon$2@6f7bcb8e
```
...
// instantWriter: PBScalarValueWriter[Instant] = pbdirect.PBScalarValueWriterImplicits$ContravariantWriter$$anon$2@31f47cfd
```
